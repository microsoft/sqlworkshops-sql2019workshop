...
As an advanced activity go through the steps of the T-SQL script **polybasediagnostics.sql** as found in the **sql2019workshop\08_DataVirtualization\polybasediags** folder to see various aspects of using diagnostics with Polybase.
